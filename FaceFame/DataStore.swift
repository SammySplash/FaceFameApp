...
struct DataStore {
    ...
    static let femaleActors: [[String]] = [
        ...
        ["Кирстен Данст", "Стала известной благодаря роли в фильме 'Человек-паук'"],
        ...
        ["Ума Турман", "Муза Квентина Тарантино, сыграла в 'Криминальном чтиве' и 'Убить Билла'"],
